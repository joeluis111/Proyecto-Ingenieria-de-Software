 ...
 */
@Embeddable
public class HistoriaInventariaPK implements Serializable, Entidad {
    ...
    public HistoriaInventariaPK(int matid, int proid) {
        this.matid = matid;
        this.proid = proid;
    }
    ...
    public String toString() {
        return "MD.HistoriaInventariaPK[ matid=" + matid + ", proid=" + proid + " ]";
    }
