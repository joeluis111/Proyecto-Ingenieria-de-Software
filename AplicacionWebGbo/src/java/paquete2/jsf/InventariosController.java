...
import paquete2.jcontroller.InventariosFacade;
...
public class InventariosController implements Serializable {
    ...
    @EJB
    private paquete2.jcontroller.InventariosFacade ejbFacade;
    ...
    public Inventarios getSelected() {
        if (current == null) {
            ...
            current.setInventariosPK(new paquete1.jpa.InventariosPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            current.getInventariosPK().setProyectoID(current.getProyectos().getProyectoID());
            current.getInventariosPK().setMaterialID(current.getMateriales().getMaterialID());
    ...
    public Inventarios getInventarios(paquete1.jpa.InventariosPK id) {
    ...
    public static class InventariosControllerConverter implements Converter {
        ...
        paquete1.jpa.InventariosPK getKey(String value) {
            paquete1.jpa.InventariosPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new paquete1.jpa.InventariosPK();
            key.setMaterialID(Integer.parseInt(values[0]));
            key.setProyectoID(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(paquete1.jpa.InventariosPK value) {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Inventarios) {
                ...
                return getStringKey(o.getInventariosPK());
            } else {
